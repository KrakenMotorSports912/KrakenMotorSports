      ...
      <div className="container mx-auto max-w-5xl space-y-8">
        ...
        <div className="card grid gap-6 lg:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input className="input-field" placeholder="Email" type="email" value={contact} onChange={(event: ChangeEvent<HTMLInputElement>) => setContact(event.target.value)} required />
