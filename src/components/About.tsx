export default function About() {
  const features = [
    { icon: '🎮', title: 'Full VR Immersion', description: 'State-of-the-art VR headset with 6DoF tracking. Lose yourself in the race.' },
    { icon: '🏎️', title: 'Direct Drive Wheel', description: 'Professional-grade force feedback system. Feel every nuance of the track.' },
    { icon: '⚡', title: 'Motion Platform', description: 'Dynamic motion system. Experience every bump, G-force, and acceleration.' },
    { icon: '🏆', title: 'Global Leaderboard', description: 'Compete against the best. Prove your skill, claim your glory.' },
  ]

  return (
    <section id="kraken-rig" className="py-24 bg-kraken-dark">
      <div className="container mx-auto px-4">
        <h2 className="section-title">THE KRAKEN RIG: PRECISION ENGINEERED FOR PURE ADRENALINE</h2>
        
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          {/* Content */}
          <div>
            <h3 className="text-3xl font-display tracking-wider text-kraken-cyan mb-6">
              DIVE INTO THE DEEP END
            </h3>
            <p className="text-lg text-kraken-gray mb-8 leading-relaxed">
              The Kraken Rig is not just another racing simulator. It's a high-octane VR experience 
              engineered for pure immersion, delivering the most authentic racing feedback available outside a real track.
            </p>
